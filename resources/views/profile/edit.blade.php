            ...
            <div class="col-md-4">
                <div class="p-3 py-5">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <button class="btn btn-info"><a href="{{route('competence.create')}}" style="color: white; text-decoration:none;">Ajouter</a></button>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <ul>    
                ...
                <div class="p-3 py-5">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <button class="btn btn-info" type="button"><a href="{{route('certification.create')}}" style="color: white; text-decoration:none;">Ajouter</a></button>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <ul>    
                ...
                <div class="p-3 py-5">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <br>
                            <button class="btn btn-info mt-auto"><a href="{{route('experience.create')}}" style="color: white; text-decoration:none;">Ajouter</a></button>              
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <ul>    
                ...
                <div class="p-3 py-5">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <button class="btn btn-info"><a href="{{route('cv_et_motivation.create')}}" style="color: white; text-decoration:none;">Ajouter</a></button>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <ul>    
